    ...
    <div className="max-w-7xl h-screen overflow-y-scroll mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex flex-wrap justify-center gap-8">
        {plans.map((plan) => (
          <div
            key={plan._id}
            className={`border border-gray-200 dark:border-purple-700 rounded-lg shadow hover:shadow-lg transition-shadow p-6 min-w-[360px] flex flex-col ${
              plan._id === "pro"
          ...
          >
            <div className="flex-1">
              ...
              <ul>
                {plan.features.map((feature, index) => (
                  <li
                    key={index}
                    className="list-disc list-inside text-sm text-gray-700 dark:text-purple-200 space-y-1"
                  >
                    {feature}
                  </li>
                ))}
            ...
            <button
              onClick={()=>toast.promise(purchasePlans(plan._id),{loading:"Processing..."})}
